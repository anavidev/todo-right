export default () => {
    ...
    <div class="containerCategoria container-fluid bg-secondary rounded-5 mt-3 p-4 position-relative">
        ...
        <i class="bi-plus-lg" id="iconCategoria"></i>
        <h1 class="mx-3">Outros</h1>
        <div class="listaTarefas container-fluid mt-3 mb-5" id="listaTarefasOutros">
    ...
    const containerGeralOutros = document.querySelector('#aplicacao');
    containerGeralOutros.innerHTML = templateOutros;

    return containerGeralOutros;
}