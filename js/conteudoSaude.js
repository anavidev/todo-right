export default () => {
    ...
    <div class="containerCategoria container-fluid bg-secondary rounded-5 mt-3 p-4 position-relative">
        ...
        <i class="bi-heart-pulse" id="iconCategoria"></i>
        <h1 class="mx-3">Saúde</h1>
        <div class="listaTarefas container-fluid mt-3 mb-5" id="listaTarefasSaude">
    ...
    const containerGeralSaude = document.querySelector('#aplicacao');
    containerGeralSaude.innerHTML = templateSaude;

    return templateSaude;
}